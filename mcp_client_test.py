...
# FOR TAVILY RESEARCH TOOL
async def get_tavily_research_tool():
    global tavily_research_tool
    if tavily_research_tool is not None:
        return
...
# async def tavily_mcp_research(query: str):
#     await get_tavily_research_tool()
#     result = await tavily_research_tool.ainvoke(
#         {
#             "query": query
#         }
#     )
